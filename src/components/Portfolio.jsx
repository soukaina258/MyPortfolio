...
export default function Portfolio() {
    ...
    useEffect(() => {
        const sectionRefs = [heroRef, projectsRef, skillsRef, aboutRef, experiencesRef, certificationsRef, contactRef];
    ...
    }, [heroRef, projectsRef, skillsRef, aboutRef, experiencesRef, certificationsRef, contactRef]);
    ...
    return (
        ...
        <div className={`min-h-screen w-full`} style={{ 
                    ...
                    <header className="header-main w-full fixed z-[99]">
                        ...
                        <div className="header-container flex items-start w-full m-auto max-w-[1800px] z-[20]">
                            <div className="header-logo-box flex items-center justify-between w-auto pr-[1em] h-[80px] rounded-b-[30px] mr-[11px] relative z-[0] group" style={{
                                ...
                                <a href="#" className="font-medium px-2 sm:px-4 ml-[1em] sm:ml-[2em] relative" style={{ width: "max-content" }}>
                                ...
                                <div className="flex items-center">
                                    <div className="text-[1.2rem] sm:text-[1.5rem] md:text-[1.8rem] font-bold tracking-tighter relative overflow-hidden">
                                        <span className={`relative z-10 ${darkMode ? 'text-white' : 'text-black'}`}>
                                            <span className="bg-gradient-to-r from-[#E870A4] via-[#E7C8A0] to-[#E870A4] bg-clip-text text-transparent">S</span>
                                            <span>oukaina</span>
                                        </span>
                                    </div>
                                    
                                    <div className="mx-1 sm:mx-2 h-6 sm:h-8 flex items-center">
                                        <div className={`w-px h-full ${darkMode ? 'bg-gradient-to-b from-[#E870A4] to-[#E7C8A0]' : 'bg-gradient-to-b from-[#E870A4] to-[#E7C8A0]'} animate-pulse`}></div>
                                    </div>
                                    
                                    <div className="text-[1.2rem] sm:text-[1.5rem] md:text-[1.8rem] font-bold tracking-tighter">
                                        <span className={`relative z-10 ${darkMode ? 'text-white' : 'text-black'}`}>
                                            <span className="bg-gradient-to-r from-[#E7C8A0] via-[#E870A4] to-[#E7C8A0] bg-clip-text text-transparent">S</span>
                                            <span>bai</span>
                                        </span>
                                    </div>
                                </div>
                                
                                <div className={`hidden sm:block text-[0.5rem] sm:text-[0.6rem] md:text-[0.7rem] tracking-[0.2em] sm:tracking-[0.3em] uppercase -mt-1 ${darkMode ? 'text-gray-400' : 'text-gray-500'} flex items-center`}>
                                    ...
                                    <div className="mobile-menu-content">
                                        ...
                                        <div className="mobile-menu-footer">
                                            ...
                                            <div className="mobile-social-links">
                                                <a href="https://github.com/soukaina258" target="_blank" rel="noopener noreferrer" className="social-link">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a href="https://www.linkedin.com/in/soukaina-sbai-6a6b1a206/" target="_blank" rel="noopener noreferrer" className="social-link">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-full flex justify-center">
                    ...
                    <div className="relative z-[5] p-10 md:p-16 flex flex-col justify-center items-center text-center w-full">
                        ...
                        <div className="mt-4 sm:mt-5 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-5 justify-center px-4 sm:px-0">
                            <a href="#projects" className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-white text-[#0D1B2A] font-medium rounded overflow-hidden text-sm sm:text-base">
                                <span className="relative z-10 flex items-center justify-center">
                                            View Projects
                                 <svg className="w-3 h-3 sm:w-4 sm:h-4 ml-2 transition-transform duration-300 group-hover:translate-x-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-r from-[#E870A4] to-[#E7C8A0] translate-y-[101%] group-hover:translate-y-0 transition-transform duration-300"></div>
                                    ...
                                    <a href="#contact" className="px-6 sm:px-8 py-3 sm:py-4 border border-white/30 text-white font-medium rounded hover:border-white/80 transition-colors duration-300 text-sm sm:text-base">
                                                Contact Me
                                    </a>
                                </div>
                        </div>
            ...
            <section id="experiences" className="experiences w-full m-[4em_auto] sm:m-[8em_auto] max-w-[1400px] px-[20px] sm:px-[40px]" ref={experiencesRef}>
                <div className="section-header relative mb-16 flex flex-col items-center">
                    <h2 className="text-lg tracking-[0.3em] uppercase font-light mb-6 relative inline-block" style={{
                    ...
                    <p className="text-sm opacity-60 mt-4" style={{
                        color: darkMode ? "#F9F8F6" : "#0D1B2A"
                    }}>
                ...
                <div className="experiences-grid relative md:min-h-[1000px]">
                    ...
                    <div className="flex flex-col gap-6 md:block">
                        ...
                        >
                            <div className="terminal-window rounded-lg overflow-hidden shadow-2xl" style={{
                                backgroundColor: darkMode ? "#0D1B2A" : "#0D1B2A",
                                border: `1px solid ${darkMode ? 'rgba(232, 112, 164, 0.3)' : 'rgba(232, 112, 164, 0.2)'}`
                            }}>
                                <div className="window-header flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-3 border-b" style={{
                                    background: darkMode ? 'linear-gradient(135deg, #0D1B2A 0%, #1a2942 100%)' : 'linear-gradient(135deg, #0D1B2A 0%, #1a2942 100%)',
                                    borderColor: 'rgba(232, 112, 164, 0.2)'
                                }}>
                                    <div className="flex gap-1.5 sm:gap-2">
                                        <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full" style={{ backgroundColor: '#ff5f56' }}></div>
                                        <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full" style={{ backgroundColor: '#ffbd2e' }}></div>
                                        <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full" style={{ backgroundColor: '#27c93f' }}></div>
                                    </div>
                                    <div className="flex gap-2 ml-2 sm:ml-4 text-[0.6rem] sm:text-xs overflow-x-auto">
                                        <div className="px-2 sm:px-3 py-1 rounded-t text-white whitespace-nowrap" style={{ backgroundColor: 'rgba(232, 112, 164, 0.2)' }}>job-1.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-2.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap hidden sm:block">job-3.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-4.js</div>
                                    </div>
                                </div>
                                <div className="code-content p-4 sm:p-6 font-mono text-xs sm:text-sm overflow-x-auto">
                                    <div className="flex">
                                        <div className="text-gray-600 mr-3 sm:mr-4 select-none text-[0.65rem] sm:text-sm">1<br/>2<br/>3<br/>4<br/>5<br/>6</div>
                                        <div className="text-[0.65rem] sm:text-sm">
                                            <span style={{ color: '#E7C8A0' }}>const</span> <span style={{ color: '#E870A4' }}>job</span> <span className="text-white">=</span> <span style={{ color: '#E7C8A0' }}>{'{'}</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>title</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"Software Engineer"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>from</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"March 2025"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>to</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"Aug 2025"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>company</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"E-Call Services (CALL BPO WEB)"</span><br/>
                        ...
                        >
                            <div className="terminal-window rounded-lg overflow-hidden shadow-2xl" style={{
                                ...
                                <div className="window-header flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-3 border-b" style={{
                                    ...
                                    <div className="flex gap-2 ml-2 sm:ml-4 text-[0.6rem] sm:text-xs overflow-x-auto">
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-1.js</div>
                                        <div className="px-2 sm:px-3 py-1 rounded-t text-white whitespace-nowrap" style={{ backgroundColor: 'rgba(232, 112, 164, 0.2)' }}>job-2.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap hidden sm:block">job-3.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-4.js</div>
                                    </div>
                                </div>
                                <div className="code-content p-4 sm:p-6 font-mono text-xs sm:text-sm overflow-x-auto">
                                    <div className="flex">
                                        ...
                                        <div className="text-[0.65rem] sm:text-sm">
                                            <span style={{ color: '#E7C8A0' }}>const</span> <span style={{ color: '#E870A4' }}>job</span> <span className="text-white">=</span> <span style={{ color: '#E7C8A0' }}>{'{'}</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>title</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"Frontend Engineer"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>from</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"Mars 2024"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>to</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"Jul 2024"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>company</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"ENSET Mohammedia"</span><br/>
                                            <span style={{ color: '#E7C8A0' }}>{'}'}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="terminal-window rounded-lg overflow-hidden shadow-2xl" style={{
                                ...
                                <div className="window-header flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-3 border-b" style={{
                                    ...
                                    <div className="flex gap-2 ml-2 sm:ml-4 text-[0.6rem] sm:text-xs overflow-x-auto">
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-1.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-2.js</div>
                                        <div className="px-2 sm:px-3 py-1 rounded-t text-white whitespace-nowrap" style={{ backgroundColor: 'rgba(232, 112, 164, 0.2)' }}>job-3.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-4.js</div>
                                    </div>
                                </div>
                                <div className="code-content p-4 sm:p-6 font-mono text-xs sm:text-sm overflow-x-auto">
                                    <div className="flex">
                                        ...
                                        <div className="text-[0.65rem] sm:text-sm">
                                            <span style={{ color: '#E7C8A0' }}>const</span> <span style={{ color: '#E870A4' }}>job</span> <span className="text-white">=</span> <span style={{ color: '#E7C8A0' }}>{'{'}</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>title</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"FullStack Developer"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>from</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"April 2023"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>to</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"July 2023"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>company</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"Architeo"</span><br/>
                                            <span style={{ color: '#E7C8A0' }}>{'}'}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="terminal-window rounded-lg overflow-hidden shadow-2xl" style={{
                                ...
                                <div className="window-header flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-3 border-b" style={{
                                    ...
                                    <div className="flex gap-2 ml-2 sm:ml-4 text-[0.6rem] sm:text-xs overflow-x-auto">
                                         <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-1.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-2.js</div>
                                        <div className="px-2 sm:px-3 py-1 text-gray-500 whitespace-nowrap">job-3.js</div>
                                        <div className="px-2 sm:px-3 py-1 rounded-t text-white whitespace-nowrap" style={{ backgroundColor: 'rgba(232, 112, 164, 0.2)' }}>job-4.js</div>
                                ...
                                <div className="code-content p-4 sm:p-6 font-mono text-xs sm:text-sm overflow-x-auto">
                                    <div className="flex">
                                        ...
                                        <div className="text-[0.65rem] sm:text-sm">
                                            <span style={{ color: '#E7C8A0' }}>const</span> <span style={{ color: '#E870A4' }}>job</span> <span className="text-white">=</span> <span style={{ color: '#E7C8A0' }}>{'{'}</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>title</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>".NET Developer"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>from</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"Jan 2022"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>to</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"April 2022"</span><span className="text-white">,</span><br/>
                                            <span className="ml-2 sm:ml-4" style={{ color: '#E870A4' }}>company</span><span className="text-white">:</span> <span style={{ color: '#98c1d9' }}>"Ministry of Justice, Morocco"</span><br/>
                                            <span style={{ color: '#E7C8A0' }}>{'}'}</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <section id="certifications" className="certifications w-full m-[8em_auto] max-w-[1160px] px-[40px]" ref={certificationsRef}>
                <div className="section-header relative mb-16 flex flex-col items-center">
                    <h2 className="text-lg tracking-[0.3em] uppercase font-light mb-6 relative inline-block" style={{
                        color: darkMode ? "#F9F8F6" : "#0D1B2A"
                    }}>
                ...
                <div className="certifications-content grid grid-cols-1 md:grid-cols-2 gap-6">
                    {certifications.map((certification, index) => (
                        <div key={index} className="certification-item p-6 rounded-2xl border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:border-[#E870A4] dark:hover:border-[#E870A4] hover:shadow-lg hover:shadow-[#E870A4]/10 flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold mb-1" style={{ color: darkMode ? "#F9F8F6" : "#000" }}>
                                    {certification.title}
                                </h3>
                                <p className="text-sm opacity-75" style={{ color: darkMode ? "#F9F8F6" : "#000" }}>
                        ...
                        <section className="technologies w-full m-auto max-w-[1160px] px-[40px] mb-20" id="technologies">
                            ...
                            <div className="tech-category w-full mb-16">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-y-8 gap-x-4">
                                    <TechIcon name="git" color={darkMode ? "#F05032" : "#F05032"} className="transform hover:scale-110 transition-all duration-300" />
                                    <TechIcon name="docker" color={darkMode ? "#4285F4" : "#4285F4"} className="transform hover:scale-110 transition-all duration-300" />
                ...
                <div className="projects-content mt-[4em] sm:mt-[6em] flex flex-col items-center w-full">
                    ...
                    >
                        ...
                        style={{
                            backgroundColor: darkMode ? "rgba(13,27,42,0.6)" : "rgba(255,255,255,0.9)",
                        ...
                        <div className="p-5 sm:p-6 md:p-8 lg:p-10">
                            ...
                            <div>
                                ...
                                style={{ color: darkMode ? "#F9F8F6" : "#0D1B2A" }}
                                >
                                Erraji Voyage is a modern travel-agency app built with React Native, Expo, Supabase, and PostgreSQL. It provides a clean interface for exploring travel packages while giving the agency full admin control over programs, flights, hotels, and destinations.
                                </p>
                            </div>
                            ...
                            style={{
                                borderColor: darkMode ? "rgba(249,248,246,0.1)" : "rgba(13,27,42,0.1)",
                            }}
                            >
                            <div
                    ...
                    >
                        ...
                        onClick={() => window.open("https://the-app-gmail.vercel.app/", "_blank")}
                        style={{
                            backgroundColor: darkMode ? "rgba(13, 27, 42, 0.6)" : "rgba(255,255,255,0.9)",
                            backdropFilter: "blur(20px)",
                            border: `2px solid ${
                        ...
                        <div className="p-5 sm:p-6 md:p-8 lg:p-10">
                            ...
                            <div>
                                ...
                                style={{ color: darkMode ? "#F9F8F6" : "#0D1B2A" }}
                                >
                                A modern email management application with AI-powered categorization and automated responses.
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <svg width="20" height="20" className="transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor">
                    ...
                    >
                        <div
                        className="card w-full rounded-2xl sm:rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 hover:shadow-2xl"
                        onClick={() => window.open("https://labcall-calls-agents.vercel.app/", "_blank")}
                        style={{
                            backgroundColor: darkMode ? "rgba(13, 27, 42, 0.6)" : "rgba(255,255,255,0.9)",
                            backdropFilter: "blur(20px)",
                            border: `2px solid ${
                        ...
                        <div className="p-5 sm:p-6 md:p-8 lg:p-10">
                            ...
                            <div>
                                ...
                                style={{ color: darkMode ? "#F9F8F6" : "#0D1B2A" }}
                                >
                                A full-stack SaaS platform that lets teams create AI voice agents without coding. Developed a FastAPI backend and a Next.js interface with drag-and-drop workflow building, real-time STT/TTS, telecom API integration, vector-store knowledge (Chroma/FAISS), and RBAC security. Delivered dashboards, call logs, automation logic, and async call handling for contact-center use cases.
                                </p>
                            </div>
                    ...
                    >
                        <div
                        className="card w-full rounded-2xl sm:rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 hover:shadow-2xl"
                        onClick={() => window.open("https://iboarding-pass.vercel.app/", "_blank")}
                        style={{
                            backgroundColor: darkMode ? "rgba(13, 27, 42, 0.6)" : "rgba(255,255,255,0.9)",
                            backdropFilter: "blur(20px)",
                            border: `2px solid ${
                        ...
                        <div className="p-5 sm:p-6 md:p-8 lg:p-10">
                            ...
                            <div>
                                ...
                                style={{ color: darkMode ? "#F9F8F6" : "#0D1B2A" }}
                                >
                                A modern web application that generates and manages digital boarding passes with real-time data, QR codes, and smooth check-in workflows. Built with React, TypeScript, and Supabase for authentication, flight data management, and fast server-side operations. Designed to improve passenger experience and simplify airline processes.
                                </p>
                            </div>
                    ...
                    <div className="w-full flex justify-center mt-8 sm:mt-12">
                        ...
                        style={{
                            backgroundColor: darkMode ? "rgba(232,112,164,0.1)" : "rgba(232,112,164,0.05)",
                            border: `2px solid ${
            ...
            <section id="about" className="about w-full m-[4em_auto] sm:m-[6em_auto] md:m-[8em_auto] max-w-[1160px] px-[20px] sm:px-[40px]" ref={aboutRef}>
                <div className="section-header relative mb-16 flex flex-col items-center">
                    <h2 className="text-lg tracking-[0.3em] uppercase font-light mb-6 relative inline-block" style={{
                        color: darkMode ? "#F9F8F6" : "#0D1B2A"
                    }}>
                ...
                <div className="about-content relative overflow-visible py-[2em] grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-[2em] sm:gap-[3em] lg:gap-[4em]">
                    ...
                    >
                        ...
                        <motion.div 
                            className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 w-[100px] h-[100px] sm:w-[120px] sm:h-[120px] md:w-[140px] md:h-[140px] bg-gradient-to-br from-[#E870A4] to-[#E7C8A0] rounded-full flex items-center justify-center shadow-lg"
                        ...
                        >
                            <div className="absolute inset-[3px] rounded-full bg-black flex flex-col items-center justify-center text-white">
                                ...
                                <span className="text-[0.6rem] sm:text-xs tracking-wide mt-1">YEARS EXP</span>
                            </div>
                        </motion.div>
                    </motion.div>
                    ...
                    <div className="text w-full flex flex-col justify-between" style={{
                        ...
                        >
                            I'm a software engineer who enjoys turning ideas into clear, thoughtful digital experiences. I focus on building 
                            <motion.span 
                                className="relative mx-2 inline-block"
                                whileHover={{ scale: 1.05 }}
                            >
                                <span className="relative z-10 text-white px-2 py-0.5 font-semibold">smooth, intuitive interfaces</span>
                            ...
                            <motion.span 
                                ...
                                whileHover={{ scale: 1.05 }}
                            >
                                <span className="relative z-10 text-white px-2 py-0.5 font-semibold">clean code, modern design</span>
                        ...
                        >
                            <motion.a
                                ...
                                whileHover={{ scale: 1.05, boxShadow: "0 20px 25px -5px rgba(232, 112, 164, 0.2), 0 8px 10px -6px rgba(231, 200, 160, 0.2)" }}
                                whileTap={{ scale: 0.98 }}
                            >
                                Get in touch
            ...
            <section id="skills" className="w-full my-[6em] sm:my-[8em] md:my-[10em] px-4 sm:px-6 md:px-10 overflow-hidden" ref={skillsRef}>
                <div className="max-w-[1400px] mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
                        ...
                        <motion.div 
                            ...
                            style={{
                                backgroundColor: darkMode ? "rgba(13, 27, 42, 0.5)" : "rgba(255, 255, 255, 0.8)",
                                borderColor: darkMode ? "rgba(232, 112, 164, 0.2)" : "rgba(13, 27, 42, 0.1)",
                                backdropFilter: "blur(10px)"
                            }}
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            transition={{ duration: 0.6 }}
                            whileHover={{ y: -8, borderColor: darkMode ? "#E870A4" : "rgba(232, 112, 164, 0.5)" }}
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-3xl font-bold mb-4 group-hover:text-[#E870A4] transition-colors duration-300" style={{
                                    color: darkMode ? "#F9F8F6" : "#0D1B2A"
                                }}>
                                    Web Development
                                </h3>
                                
                                <p className="text-lg leading-relaxed opacity-80 mb-6" style={{
                                    color: darkMode ? "#F9F8F6" : "#0D1B2A"
                                }}>
                                    Building responsive, high-performance web applications with modern frameworks and best practices. From concept to deployment, I create seamless digital experiences.
                                </p>
                                
                                <div className="flex flex-wrap gap-2">
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E870A4]/10 text-[#E870A4] border border-[#E870A4]/20">React</span>
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E870A4]/10 text-[#E870A4] border border-[#E870A4]/20">Next.js</span>
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E870A4]/10 text-[#E870A4] border border-[#E870A4]/20">TypeScript</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.6, delay: 0.1 }}
                            whileHover={{ y: -8, borderColor: darkMode ? "#E7C8A0" : "rgba(231, 200, 160, 0.5)" }}
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-3xl font-bold mb-4 group-hover:text-[#E7C8A0] transition-colors duration-300" style={{
                                    color: darkMode ? "#F9F8F6" : "#0D1B2A"
                                }}>
                                    Mobile Development
                                </h3>
                                ...
                                <p className="text-lg leading-relaxed opacity-80 mb-6" style={{
                                    ...
                                    Creating native and cross-platform mobile applications with smooth performance and intuitive interfaces. Bringing your ideas to iOS and Android.
                                </p>
                                
                                <div className="flex flex-wrap gap-2">
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E7C8A0]/10 text-[#E7C8A0] border border-[#E7C8A0]/20">React Native</span>
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E7C8A0]/10 text-[#E7C8A0] border border-[#E7C8A0]/20">Flutter</span>
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E7C8A0]/10 text-[#E7C8A0] border border-[#E7C8A0]/20">iOS/Android</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-lg leading-relaxed opacity-80 mb-6" style={{
                                    ...
                                    Crafting intuitive and beautiful user interfaces that prioritize user experience. Every pixel matters in creating engaging digital products.
                                </p>
                                
                                <div className="flex flex-wrap gap-2">
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E870A4]/10 text-[#E870A4] border border-[#E870A4]/20">UI/UX</span>
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E870A4]/10 text-[#E870A4] border border-[#E870A4]/20">Figma</span>
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E870A4]/10 text-[#E870A4] border border-[#E870A4]/20">Prototyping</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#0D1B2A] to-[#E7C8A0] flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 shadow-lg">
                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 5C16.4183 5 20 4.32843 20 3.5C20 2.67157 16.4183 2 12 2C7.58172 2 4 2.67157 4 3.5C4 4.32843 7.58172 5 12 5Z" stroke="white" strokeWidth="2"/>
                                        <path d="M20 3.5V20.5C20 21.3284 16.4183 22 12 22C7.58172 22 4 21.3284 4 20.5V3.5" stroke="white" strokeWidth="2"/>
                                        <path d="M20 12C20 12.8284 16.4183 13.5 12 13.5C7.58172 13.5 4 12.8284 4 12" stroke="white" strokeWidth="2"/>
                                    </svg>
                                </div>
                                ...
                                <p className="text-lg leading-relaxed opacity-80 mb-6" style={{
                                    ...
                                    End-to-end development from database design to frontend implementation. Building scalable architectures that grow with your business needs.
                                </p>
                                
                                <div className="flex flex-wrap gap-2">
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E7C8A0]/10 text-[#E7C8A0] border border-[#E7C8A0]/20">Node.js</span>
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E7C8A0]/10 text-[#E7C8A0] border border-[#E7C8A0]/20">APIs</span>
                                    <span className="px-3 py-1 rounded-full text-xs font-medium bg-[#E7C8A0]/10 text-[#E7C8A0] border border-[#E7C8A0]/20">Databases</span>
                                </div>
                            </div>
                        </motion.div>
           ...
           {/* Contact Section - Modern Redesign */}
            <section id="contact" className="contact-container w-full max-w-[1800px] m-[2em_auto_auto] h-auto px-[15px] sm:px-[20px] md:px-[40px]" ref={contactRef}>
                <div className="relative w-full overflow-hidden h-auto min-h-[800px] sm:min-h-[780px] md:h-[750px] rounded-[20px] sm:rounded-[30px] md:rounded-[40px] mb-[2em]">
                    ...
                    <div className="absolute inset-0 rounded-[20px] sm:rounded-[30px] md:rounded-[40px] overflow-hidden">
                        <img src="/bg.webp" alt="Contact background" className="absolute inset-0 w-full h-full object-cover"/>
                    ...
                    <div className="relative h-full flex flex-col justify-between z-[2] py-[3em] sm:py-[4em] md:py-[6em] px-[2em] sm:px-[3em] md:px-[5em] lg:px-[8em]">
                        ...
                        >
                            ...
                            >
                                <span className="text-[#E870A4] text-sm sm:text-base font-medium tracking-wide">💼 Available for Projects</span>
                            </motion.div>
                            ...
                            >
                                Have a project in mind? Let's discuss how we can bring your vision to life with elegant code and thoughtful design.
                            </motion.p>
                        </motion.div>
                                ...
                                <div className="flex flex-col items-start sm:items-end gap-3 translate-y-[-20px] sm:translate-y-[-40px]">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <motion.a 
                                            ...
                                            whileTap={{ scale: 0.95 }}
                                        >
                                            <span className="absolute inset-0 bg-[#E870A4]/10 scale-0 group-hover:scale-100 
